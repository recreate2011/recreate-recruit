...
const voices = [
  ...
  { name: "田中 さくら", office: "十三事業所", role: "介護職 / 入社3年目", img: "/images/スタッフの声(赤).jpg" },
  {
    ...
    office: "豊中事業所",
    role: "介護職 / 入職3年目",
    img: "/images/interview-careworker1.jpg",
    slug: "suzuki-kenta",
    interview: {
      ...
      qa: [
        ...
        { q: "リクリエイトに入職した決め手はなにでしたか？また入職の前と後で感じたギャップはなにかありますか？", a: "正直なところ入職の決め手として「これ」というものがあったわけではありません。それまで接客業をしていて、介護の現場は未経験だったので、最初は技術面の習得にかなり苦労しました。体の動かし方ひとつ、声のかけ方ひとつも手探りで、先輩に教えてもらいながら少しずつ覚えていった感じです。" },
        { q: "この職場で働いて「よかった」と感じる瞬間はなにかありますか？", a: "サービスが終わったあとに、利用者様から「来てくれてありがとう」と言ってもらえる瞬間です。何気ない一言かもしれませんが、その言葉に仕事のやりがいを感じます。" },
        { q: "仕事で大変なことと、またどのように克服したのか教えてください", a: "利用者様によって、コミュニケーションの取り方の幅が大きく異なります。文章レベルでの理解はできても、言葉として表出するのは単語レベルまでだったり、「あー」「うー」といった発声だけで気持ちを伝えようとされる方もいます。また、認知面の特性から、言葉そのものの理解が難しい方もいらっしゃいます。そうした違いを踏まえて、その方に合った伝え方・受け取り方を一人ひとり考えながら関わるようにしています。" },
        { q: "この仕事をしていて印象に残っているエピソードについて教えてください", a: "小学校時代から、約10年にわたって関わり続けている利用者様がいます。自分が関わることで、少しずつできることが増えていったり、成長とともに生活の幅や活動できる範囲が広がっていったり。すこしずつ他人を思いやることが出来る優しい心が育っていったり——利用者さんが成長する姿を見守ることが出来たことが、自分の大きな財産になってます。" },
        { q: "どんな人と一緒に働きたいですか？", a: "素直で、一生懸命な人と一緒に働きたいです。目の前の利用者様に真剣に向き合おうとする姿勢を大事できるそんな方と働くことが出来たら嬉しいです。" },
      ],
    },
  },
];
    ...
    <>
      <style>{`
        ...
        .interview-fixed-footer {
          ...
          background: #f5a623; height: 22px;
          display: flex; align-items: center; justify-content: center;
        }
        .interview-fixed-footer a { text-decoration: none; font-family: 'Shippori Mincho', serif; font-size: 15px; font-weight: 700; color: #fff; line-height: 1; }
      `}</style>
      <Header alwaysWhite />
              ...
              <div style={{ borderRadius: 10, overflow: "hidden", maxWidth: 220, margin: "0 auto" }}>
                <div style={{ position: "relative", aspectRatio: "4/3" }}>
                  ...
                  <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top,rgba(83,70,89,0.78) 0%,rgba(83,70,89,0.25) 55%,rgba(83,70,89,0.02) 100%)", display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: 16 }}>
                    ...
                    <p style={{ fontFamily: "'Noto Sans JP', sans-serif", fontSize: 13, fontWeight: 700, color: "var(--white)", lineHeight: 1.4, whiteSpace: "nowrap", alignSelf: "flex-start", marginLeft: 8 }}>{w.title}</p>
                  </div>
                </div>
              </div>
            </Reveal>
